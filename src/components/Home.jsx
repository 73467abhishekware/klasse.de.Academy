  ...
  const testimonials = [
    {
      ...
      image: "🎓",
      quote:
        "Thank you for helping me gain admission to a German university. Your excellent guidance made my dream come true.",
    ...
    },
    {
      ...
      image: "🎯",
      quote:
        "C1 felt impossible before, but practical speaking drills and personalized attention made it achievable.",
    ...
    },
    {
      ...
      image: "🌟",
      quote:
        "I got admits in two German universities! The SOP guidance was exceptional.",
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-black via-red-600 to-yellow-500 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div
              className={`space-y-8 z-10 transition-all duration-1000 transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
              <div className="inline-block animate-fade-in-down">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm mb-6 hover:bg-white/20 transition-all duration-300 cursor-pointer">
                  <Award className="w-4 h-4 animate-pulse" />
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight animate-fade-in">
                ...
                <span className="inline-block hover:scale-110 transition-transform duration-300 bg-gradient-to-r from-yellow-400 to-red-500 bg-clip-text text-transparent">
                  Gateway
                </span>{" "}
                <span className="inline-block hover:scale-110 transition-transform duration-300">
                  to
              ...
              <p className="text-lg md:text-xl text-gray-100 leading-relaxed animate-fade-in animation-delay-500">
                We don't just teach German. We prepare you for life, study and
                work in Germany.
              </p>
            ...
            {/* Right Image */}
            <div
              className={`relative z-10 hidden md:block transition-all duration-1000 transform ${isVisible ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"}`}
            >
              <div className="relative">
                {/* Main Image */}
                <div className="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 hover:rotate-1 transition-all duration-500">
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <div
                  className={`w-14 h-14 rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 relative z-10`}
                >
                  <Icon className="w-7 h-7 text-white group-hover:animate-bounce" />
                </div>
                ...
                <p className="text-red-600 font-medium relative z-10">
                  {item.subtitle}
                </p>
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden animate-fade-in hover:shadow-2xl transition-all duration-500">
          <div className="grid md:grid-cols-2 gap-0">
            <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                Learning is interactive: role-plays, real-life scenarios, exam
                prep + beyond.
              </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  return (
                    <div
                      key={idx}
                      className="flex items-center gap-3 group cursor-pointer transform hover:translate-x-2 transition-all duration-300"
                    >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 mb-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Real experiences from students who achieved their German dreams with
            us.
          </p>
        </div>
